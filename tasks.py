...
@app.task(name='crawl-nyt-keyword', queue=queues['nyt'])
def crawl_nyt_keyword(keyword_string, language):
    """
    ...
    DEFAULT_LOGGER.log('Received nyt keyword crawl request for {} ({})'.format(keyword_string, language), log_type=LogTypes.INFO.value)
